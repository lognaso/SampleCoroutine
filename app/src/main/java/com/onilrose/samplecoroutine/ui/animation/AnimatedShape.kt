...
) : View(context, attributeSet), androidx.lifecycle.Observer<Set<AnimatedShape>> {
...
class AnimationModel : ViewModel(), CoroutineScope {
    ...
    fun observe(owner: LifecycleOwner, observer: androidx.lifecycle.Observer<Set<AnimatedShape>>) =
